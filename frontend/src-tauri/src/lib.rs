...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            professional_identity::commands::authority_scope_policy_get,
            professional_identity::commands::authority_scope_policy_activate,
            ...
            live_assist::assist_dismiss_authority_warning,
            live_assist::assist_inspect_authority_evidence,
